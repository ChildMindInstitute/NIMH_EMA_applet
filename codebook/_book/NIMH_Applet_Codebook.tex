...
\usepackage{hyperref}
\hypersetup{
            pdftitle={Applet Codebook: NIMH EMA for Mindlogger v0.27},
            pdfauthor={Mike X.},
            pdfborder={0 0 0},
            breaklinks=true}
...
{[}1{]} ``\textbf{Question}: "How many times did you \textbf{wake up in the night}, not counting your final awakening?"''
...
{[}1{]} ``\textbf{Question}: "What time did you \textbf{wake up} this morning?"''
...
{[}1{]} ``\textbf{Question}: "What time did you \textbf{get out of bed} for the day?"''
...
{[}1{]} ``\textbf{Question}: "About how many hours did you \textbf{actually sleep}?"''
...
{[}1{]} ``\textbf{Question}: "How would you rate the \textbf{quality} of your sleep?"''
...
{[}1{]} ``\textbf{Question}: "How \textbf{refreshed} did you feel when you woke up?"''
...
{[}1{]} ``\textbf{Question}: "Did you take \textbf{sleeping pills or anything else} to help you sleep last night?"''
...
{[}1{]} ``\textbf{Question}: "Were you using your \textbf{social media} accounts \textbf{after bedtime}?"''
...
{[}1{]} ``\textbf{Question}: "Did your use of social media impact your ability to \textbf{fall asleep} last night?"''
...
{[}1{]} ``\textbf{Question}: "What are you doing at \textbf{this moment}?"''
...
{[}1{]} ``\textbf{Question}: "How \textbf{happy versus sad} do you feel right now?"''
...
{[}1{]} ``\textbf{Question}: "How \textbf{relaxed versus anxious} do you feel right now?"''
...
{[}1{]} ``\textbf{Question}: "How well can you make \textbf{decisions} right now?"''
...
{[}1{]} ``\textbf{Question}: "How \textbf{quick} is your \textbf{thinking}?"''
...
{[}1{]} ``\textbf{Question}: "How much are you able to \textbf{enjoy and feel pleasure} in things?"''
...
{[}1{]} ``\textbf{Question}: "To what extent are you having \textbf{negative thoughts}, thinking about unpleasant experiences or things that make you feel bad?"''
...
{[}1{]} ``\textbf{Question}: "Were these thoughts \url{about:/}''"
...
{[}1{]} ``\textbf{Question}: "How \textbf{severe or disturbing} would you say these thoughts were?"''
...
{[}1{]} ``\textbf{Question}: "Were these thoughts about things that could be \textbf{dangerous} for you physically?"''
...
\begin{flushleft}\includegraphics[width=0.33\linewidth]{downloadFigs4latex_NIMH_Applet_Codebook/now_thoughts_dangerous_headerImg} \end{flushleft}
...
{[}1{]} ``\textbf{Question}: "Since the last signal did you have thoughts of harming yourself or of suicide?"''
...
\begin{flushleft}\includegraphics[width=0.33\linewidth]{downloadFigs4latex_NIMH_Applet_Codebook/now_thoughts_suicide_headerImg} \end{flushleft}
...
{[}1{]} ``\textbf{Question}: "Since the last questionnaire, did you have a nap or rest?"''
...
{[}1{]} ``\textbf{Question}: "About \textbf{how long} was your nap or rest?"''
...
{[}1{]} ``\textbf{Question}: "Was this \textbf{vigorous activity} (or activities) part of a \textbf{planned} workout or exercise routine?"''
...
{[}1{]} ``\textbf{Question}: "Was this \textbf{moderate activity} (or activities) part of a \textbf{planned} workout or exercise routine?"''
...
{[}1{]} ``\textbf{Question}: "How many 8 oz glasses of \textbf{milk} did you consume?"''
...
{[}1{]} ``\textbf{Question}: "How many 8 oz glasses of \textbf{caffeinated drinks} did you consume?"''
...
{[}1{]} ``\textbf{Question}: "What type of \textbf{alcoholic beverage} did you consume?"''
...
{[}1{]} ``\textbf{Question}: "How many servings of \textbf{alcohol} did you consume?"''
...
{[}1{]} ``\textbf{Question}: "How many 8 oz glasses of \textbf{high-sugar drinks} (e.g., juice, soda, some coffee beverages) did you consume?"''
...
{[}1{]} ``\textbf{Question}: "How many \textbf{small meals} did you have?"''
...
{[}1{]} ``\textbf{Question}: "How many \textbf{regular/full meals} did you have?"''
...
{[}1{]} ``\textbf{Question}: "Did you eat chocolate?"''
...
{[}1{]} ``\textbf{Question}: "How many \textbf{cigarettes} did you have?"''
...
{[}1{]} ``\textbf{Question}: "How many \textbf{joints (of cannabis/pot)} did you have?"''
...
{[}1{]} ``\textbf{Question}: "Which of the \textbf{following categories} best describes the area of your life in which the \textbf{event occurred}?"''
...
{[}1{]} ``\textbf{Question}: "To what degree did this event have a \textbf{positive impact} on you?"''
...
{[}1{]} ``\textbf{Question}: "To what degree did this event have a \textbf{negative impact} on you?"''
...
{[}1{]} ``\textbf{Question}: "To what degree did this other event have a \textbf{negative impact} on you?"''
...
{[}1{]} ``\textbf{Question}: "Are you in \textbf{pain right now} (other than headache pain)?"''
...
{[}1{]} ``\textbf{Question}: "\textbf{Where} did this pain occur?"''
...
{[}1{]} ``\textbf{Question}: "How \textbf{severe} was the pain you experienced since you woke up?"''
...
{[}1{]} ``\textbf{Question}: "What time did the headache \textbf{begin}?"''
...
{[}1{]} ``\textbf{Question}: "Is this headache \textbf{still present}?"''
...
{[}1{]} ``\textbf{Question}: "What time did the headache \textbf{end}?"''
...
{[}1{]} ``\textbf{Question}: "How \textbf{intense} is (or was) the headache?"''
...
{[}1{]} ``\textbf{Question}: "Did the headache come on \textbf{suddenly}?"''
...
{[}1{]} ``\textbf{Question}: "Did something in particular \textbf{trigger} the headache?"''

\textbf{Visibility}: \protect\hyperlink{headache}{headache} = 2, \textbf{Visibility}: \protect\hyperlink{headache_trigger}{headache\_trigger} = 1
...
{[}1{]} ``\textbf{Question}: "What do you think \textbf{triggered} the headache?"''

\textbf{Visibility}: \protect\hyperlink{headache_trigger}{headache\_trigger} = 1, \textbf{Visibility}: \protect\hyperlink{headache}{headache} = 2
...
{[}1{]} ``\textbf{Question}: "\textbf{Where} is (or was) the headache?"''
...
{[}1{]} ``\textbf{Question}: "Is (or was) the pain \textbf{throbbing}, \textbf{beating} or \textbf{pulsating}?"''
...
{[}1{]} ``\textbf{Question}: "Does (or did) the headache pain \textbf{increase with routine physical activity} such as bending over or climbing stairs?"''
...
{[}1{]} ``\textbf{Question}: "How much does (or did) \textbf{noise} such as music, talking, TV, bother you?"''
...
{[}1{]} ``\textbf{Question}: "How much does (or did) \textbf{certain odors} such as perfume, food, smoke, bother you?"''
...
{[}1{]} ``\textbf{Question}: "Is (or was) your headache accompanied by any \textbf{numbing or tingling} in certain body areas?"''
...
{[}1{]} ``\textbf{Question}: "When did this \textbf{difficulty} occur with respect to the \textbf{onset} of the headache?"''
...
{[}1{]} ``\textbf{Question}: "How much does (or did) the headache \textbf{interfere with your activities}?"''
...
{[}1{]} ``\textbf{Question}: "Since the last questionnaire, did you do any of the following to \textbf{prevent a headache}?"''
...
{[}1{]} ``\textbf{Question}: "How \textbf{stressful} was your day overall?"''
...
{[}1{]} ``\textbf{Question}: "What areas were stressful for you today?"''
...
{[}1{]} ``\textbf{Question}: "Was today a relatively \textbf{typical day} for you in terms of \textbf{stress}?"''
...
{[}1{]} ``\textbf{Question}: "Do you have a \textbf{cold}, \textbf{cough}, or \textbf{flu} today?"''
...
{[}1{]} ``\textbf{Question}: "Did you have any of the \textbf{following problems} today?"''
...
{[}1{]} ``\textbf{Question}: "How much did your \textbf{allergies} bother you today?"''
...
{[}1{]} ``\textbf{Question}: "How much did your \textbf{asthma or respiratory difficulties} bother you today?"''
...
{[}1{]} ``\textbf{Question}: "How much did your \textbf{muscle/joint pain} bother you today?"''
...
{[}1{]} ``\textbf{Question}: "How much did your \textbf{heart racing or pounding} bother you today?"''
...
{[}1{]} ``\textbf{Question}: "Did these feelings of \textbf{dizziness} occur in a particular situation (in a bus, in hot weather, or other condition)?"''
...
{[}1{]} ``\textbf{Question}: "Did you actually \textbf{faint} today?"''
...
{[}1{]} ``\textbf{Question}: "Did you take any \textbf{prescription medications} today?"''
...
{[}1{]} ``\textbf{Question}: "For which of the following conditions?"''
...
{[}1{]} ``\textbf{Question}: "If you reported a headache present at any questionnaire today, how many \textbf{hours did the headache(s) last in total}?"''
...
{[}1{]} ``\textbf{Question}: "\textbf{Where} did you use the \textbf{internet}?"''
...
{[}1{]} ``\textbf{Question}: "What is the \textbf{main way} you communicated with your friends today?"''
...
{[}1{]} ``\textbf{Question}: "\textbf{How many hours} did you spend on \textbf{social media} today?"''
